-- The base GGNN class.  This is an alternative implementation that uses the
-- simpler "vanilla RNN" style networks for updating node state vectors.
--
-- Exactly the same as BaseGGNNSimple.lua, except that the Tanh nonlinearity is
-- removed.
--
-- Yujia Li, 04/2016
--
...
function BaseGGNN:create_one_node_update_net(n_nodes_list)
    ...
    for i=1,n_graphs do
        ...
        output[i] = ggnn.create_or_share('Linear', ggnn.NODE_UPDATE_NET_PREFIX .. '-transform', self.module_dict, {self.state_dim * 3, self.state_dim})(joined_input)
